...
public final class IOUtilities {
	...
	/**
	 * Transfers bytes from an input stream to an output stream. Callers of this
	 * method are responsible for closing the streams since they are the ones
	 * that opened the streams.
	 */
	...
	/**
	 * Use this when you expect a byte[] length of bytes to be read from the
	 * InputStream
	 */
